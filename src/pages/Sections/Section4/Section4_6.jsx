// ./src/pages/Sections/Section4/Formulario4_6.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Importación del arreglo de preguntas de operación
import { questions4_6 as form4_6Questions } from "./../../../questions/questions4/questions4_6"; // Importación del arreglo de preguntas 4.6
...
const Formulario4_6 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 4.6 enviado", formData);
