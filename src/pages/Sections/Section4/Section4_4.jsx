// ./src/pages/Sections/Section4/Formulario4_4.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Importación del arreglo de preguntas de operación
import { questions4_4 as form4_4Questions } from "./../../../questions/questions4/questions4_4"; // Importación del arreglo de preguntas 4.4
...
const Formulario4_4 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 4.4 enviado", formData);
