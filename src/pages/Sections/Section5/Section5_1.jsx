// ./src/pages/Sections/Section5/Formulario5_1.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Asegúrate de tener este archivo si aplica
import { questions5_1 as form5_1Questions } from "./../../../questions/questions5/questions5_1"; // Importación del arreglo de preguntas 5.1
...
const Formulario5_1 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 5.1 enviado", formData);
