// ./src/pages/Sections/Section5/Formulario5_2.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Asegúrate de tener este archivo si aplica
import { questions5_2 as form5_2Questions } from "./../../../questions/questions5/questions5_2"; // Importación del arreglo de preguntas 5.2
...
const Formulario5_2 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 5.2 enviado", formData);
