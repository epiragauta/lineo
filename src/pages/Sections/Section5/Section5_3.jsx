// ./src/pages/Sections/Section5/Formulario5_3.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Asegúrate de tener este archivo si aplica
import { questions5_3 as form5_3Questions } from "./../../../questions/questions5/questions5_3"; // Importación del arreglo de preguntas 5.3
...
const Formulario5_3 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 5.3 enviado", formData);
