// ./src/pages/Sections/Section5/Formulario5_5.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Asegúrate de tener este archivo si aplica
import { questions5_5 as form5_5Questions } from "./../../../questions/questions5/questions5_5"; // Importación del arreglo de preguntas 5.5
...
const Formulario5_5 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 5.5 enviado", formData);
