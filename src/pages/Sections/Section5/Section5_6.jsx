// ./src/pages/Sections/Section5/Formulario5_6.js

import React, { useState, useEffect } from "react";
import { operationQuestions } from "./../../../questions/operation_questions"; // Asegúrate de tener este archivo si aplica
import { questions5_6 as form5_6Questions } from "./../../../questions/questions5/questions5_6"; // Importación del arreglo de preguntas 5.6
...
const Formulario5_6 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Formulario 5.6 enviado", formData);
