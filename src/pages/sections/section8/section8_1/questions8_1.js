export const questions8_1 = [
  ...
  // Pregunta de Tipo Sugerencias
  {
    ...
    label: "¿Tiene alguna sugerencia o comentario sobre cómo la alta dirección podría mejorar su apoyo en las actividades previas a la recolección o acopio en la operación estadística de calidad dentro de la organización?",
