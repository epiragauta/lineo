export const questions7_7 = [
  ...
  // Pregunta de Tipo Text Area: Sugerencias para mejorar
  {
    ...
    label: "7.	¿Tiene alguna sugerencia o comentario sobre cómo la alta dirección podría mejorar su apoyo en las pruebas en la operación estadística de calidad dentro de la organización?",
