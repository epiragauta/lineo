export const questions7_1 = [
  ...
  // Pregunta de Tipo Text Area: Sugerencias
  {
    ...
    label: "¿Tiene alguna sugerencia o comentario sobre cómo la alta dirección podría mejorar su apoyo en la construcción del marco estadístico en la operación estadística de calidad dentro de la organización?",
