export const questions7_2 = [
  ...
  // Pregunta de Tipo Text Area: Sugerencias
  {
    ...
    label: "¿Tiene alguna sugerencia o comentario sobre cómo la alta dirección podría mejorar su apoyo en la construcción del instrumento de recolección en la operación estadística de calidad dentro de la organización?",
