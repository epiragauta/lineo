export const questions7_5 = [
  ...
  // Pregunta de Tipo Sugerencias
  {
    ...
    label: "¿Tiene alguna sugerencia o comentario sobre cómo la alta dirección podría mejorar su apoyo en la elaboración de materiales para la recolección o acopio en la construcción de la operación estadística de calidad dentro de la organización?",
