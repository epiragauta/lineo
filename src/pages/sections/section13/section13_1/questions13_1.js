export const questions13_1 = [
    ...
    {
      type: "sectionTitle",
      key: "determinacion_oportunidades_mejora_13_1",
      title: "Determinación de Oportunidades de Mejora",
    },
  
    // Pregunta de Tipo Ratio: Determinación y selección de oportunidades de mejora
    {
      type: "radio",
    ...
    {
      type: "sectionTitle",
      key: "acciones_corregir_prevenir_reducir_efectos_no_deseados_13_1",
      title: "Acciones para Corregir, Prevenir o Reducir Efectos No Deseados",
    },
  
    // Pregunta de Tipo Ratio: Orientación de las oportunidades de mejora
    {
      type: "radio",
    ...
    {
      type: "sectionTitle",
      key: "implementacion_acciones_mejora_13_1",
      title: "Implementación de Acciones de Mejora",
    },
  
    // Pregunta de Tipo Ratio: Implementación de acciones necesarias
    {
      type: "radio",
    ...
    {
      type: "sectionTitle",
      key: "evaluacion_efectividad_mejoras_13_1",
      title: "Evaluación de la Efectividad de las Mejoras",
    },
  
    // Pregunta de Tipo Ratio: Evaluación de la efectividad de las mejoras
    {
      type: "radio",
    ...
    // Evidencias Documentales para Generalidades
    {
      type: "evidencias",
      key: "evidencias_generalidades_13_1",
      namePrefix: "generalidades_13_1",
      fields: [
        { name: "generalidades_evidencia1_13_1", initialValue: "" },
        { name: "generalidades_evidencia2_13_1", initialValue: "" },
        { name: "generalidades_evidencia3_13_1", initialValue: "" },
      ],
    },
