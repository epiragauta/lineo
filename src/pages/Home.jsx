...
const Home = () => {
  return (
    <div className="bg-white p-6 rounded shadow-md max-w-7xl mx-auto w-full">  
      <h1 className="text-5xl font-bold mb-4">Bienvenido a la herramienta de verificación</h1>
      <div className="text-gray-800 text-3xl space-y-4 ">
        ...
        <p className="leading-relaxed border-t-2 border-primary pt-4">
          Esta herramienta técnica y estratégica ha sido diseñada para monitorear y evaluar la implementación de los lineamientos establecidos
