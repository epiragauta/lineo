    ...
    <div className="bg-login-bg bg-cover bg-no-repeat">
      <div className="w-full max-w-7xl mx-auto p-4">
        <div className="p-6 bg-white shadow-md rounded bg-opacity-60">
          <h1 className="text-2xl font-semibold mb-6 text-dark_blue">Dashboard General de las secciones</h1>

          {loading && <p className="text-dark_blue">Cargando...</p>}
          ...
          {!loading && !error && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {accumulatedData.map((section, index) => (
                <div key={index} className="bg-gray-200 p-4 border border-primary rounded shadow-md">
                  <h2 className="text-lg font-semibold mb-4 text-dark_blue">{section.section}</h2>
                  <DashboardCard
                  ...
                  <DashboardCard
                    ...
                    title={`Nivel ${section.sectionLevel.level ? section.sectionLevel.level : "N/A"}`}
                    value={section.sectionLevel.description ? section.sectionLevel.description : "N/A"}
